...
class RoverMapping(Node):
    def __init__(self, name):
        ...
        self.ignore_id = (
            self.get_parameter("~/ignore_id").get_parameter_value().bool_value
        )
        self.target_frame = (
        ...
        for m in markers.markers:
            try:
                ...
                if self.ignore_id:
                    ...
                    self.mapper.update_ar(
                        self.get_logger(), Z, m.marker_id, self.ar_precision
                    )
