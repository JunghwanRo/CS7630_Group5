// Possible topic 1: add interpolation between the plan points to make the robot move smoothly, following the time. For example, if the plan says 0, 45 degree, we interpolate it with 0, 9, 18, 27, 36, 45 degree, and publish the trajectory with the corresponding time.
#include <vector>
#include <string>
#include <map>
#include <list>
